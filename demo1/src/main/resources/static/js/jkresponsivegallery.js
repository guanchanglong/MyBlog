...
(function($){
  ...
  firstScriptTag.parentNode.insertBefore(tag, firstScriptTag)
	...
	var galleryui = '<div class="responsivegallery">'
								...
								+ '<div class="close"><span><i class="close icon"></i></span></div>'
								+ '<div class="leftnav"><span><i class="angle left icon"></i></span></div><div class="rightnav"><span><i class="angle right icon"></i></span></div>'
	...
	function buildfigure(mediafigure, curmedia, totalmedia){
		...
		figurehtml += '<img src="' + mediafigure[0] + '" style="opacity: 1 !important;"/>\n'
