...
import com.gcl.demo1.dao.jpa.MessageDao;
...
public class IMessageService implements MessageService {
    ...
    public Message saveMessage(Message message) {
        ...
        if (parentMessageId != -1) {
            message.setParentMessage(messageDao.findById(parentMessageId).get());
        } else {
    ...
    public Page<Message> listMessage(Pageable pageable) {
        ...
        Page<Message> messagePageEntity = messageDao.findAll(pageable);
        /*List转Page*/
    ...
    public void findParentMessage(Message message) {
        ...
        if(parentMessage == null){
            ...
            Message parent = messageDao.findById(parentMessage.getId()).get();
